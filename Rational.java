/*
Manchester City United - Max "Sergio Aguero", Lorenz "Wayne Rooney" Vargas
APCS1 pd10
...
public class Rational implements Comparable{
  ...
  public void divide(Rational divisor){
    ...
    public Rational[] normalize(Rational r){
        ...
        Rational new1 = new Rational((int)(this.numerator*(cm/this.denominator)), cm);
        Rational new2 = new Rational((int)(r.numerator*(cm/r.denominator)), cm);
        Rational[] ret = {new1, new2};
        return ret;
    }
  ...
  public static void main (String[] args){
	...
	//testing .equals 
	Rational test11 = new Rational(10000,20000);
	Rational test12 = new Rational(3,6);
	System.out.println(test11.equals(test12)); // should be true
	
	System.out.println(test8.equals(test10)); //should be false
  }
}
